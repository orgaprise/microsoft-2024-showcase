...
export const reverseRouteMappings: Record<string, { lang: Language; basePath: string }> = {
  ...
  "/en/shop": { lang: "en", basePath: "/shop" },
  "/en/about": { lang: "en", basePath: "/about" },
  "/en/blog": { lang: "en", basePath: "/blog" },
  "/es": { lang: "es", basePath: "/" },
  "/es/contacto": { lang: "es", basePath: "/contact" },
  "/es/productos": { lang: "es", basePath: "/products" },
  "/es/tienda": { lang: "es", basePath: "/shop" },
  "/es/nosotros": { lang: "es", basePath: "/about" },
...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Shop Page
    "shop.badge": "Our Store",
    "shop.title": "Microsoft Software Store",
    "shop.description": "Browse our complete collection of genuine Microsoft software licenses with instant digital delivery.",
    
    // About Page
    "about.badge": "About Us",
    "about.title": "Your Trusted Microsoft Partner",
    "about.description": "PRISE KEYS is an authorized Microsoft Partner dedicated to providing genuine software licenses with exceptional service and support.",
    ...
    "about.mission.description1": "At PRISE KEYS, we believe everyone deserves access to genuine, high-quality software at competitive prices. As a certified Microsoft Partner, we bridge the gap between premium software and affordability.",
    "about.mission.description2": "We're committed to providing instant digital delivery, authentic licenses, and round-the-clock customer support to ensure your software experience is seamless from purchase to installation.",
    "about.partner.title": "Microsoft Certified Partner",
    "about.partner.description": "Officially authorized to sell genuine Microsoft products",
    "about.benefits.1": "100% genuine Microsoft licenses with full warranty",
    "about.benefits.2": "Instant digital delivery within seconds",
    "about.benefits.3": "24/7 expert customer support",
    "about.benefits.4": "Best price guarantee with secure payments",
    "about.values.title": "Our Core Values",
    "about.values.description": "The principles that guide everything we do",
    "about.values.trust.title": "Trust & Authenticity",
    "about.values.trust.description": "We only sell 100% genuine Microsoft products sourced directly from authorized channels.",
    "about.values.quality.title": "Quality Service",
    "about.values.quality.description": "Excellence in every interaction, from browsing to post-purchase support.",
    "about.values.customer.title": "Customer First",
    "about.values.customer.description": "Your satisfaction is our priority. We go above and beyond for every customer.",
    "about.values.speed.title": "Speed & Efficiency",
    "about.values.speed.description": "Instant delivery and quick response times because your time matters.",
  ...
  es: {
    ...
    // Shop Page
    "shop.badge": "Nuestra Tienda",
    "shop.title": "Tienda de Software Microsoft",
    "shop.description": "Explora nuestra colección completa de licencias de software Microsoft genuino con entrega digital instantánea.",
    
    // About Page
    "about.badge": "Sobre Nosotros",
    "about.title": "Tu Partner de Microsoft de Confianza",
    "about.description": "PRISE KEYS es un Partner Autorizado de Microsoft dedicado a proporcionar licencias de software genuinas con un servicio y soporte excepcionales.",
    ...
    "about.mission.description1": "En PRISE KEYS, creemos que todos merecen acceso a software genuino de alta calidad a precios competitivos. Como Partner Certificado de Microsoft, cerramos la brecha entre el software premium y la asequibilidad.",
    "about.mission.description2": "Estamos comprometidos a proporcionar entrega digital instantánea, licencias auténticas y soporte al cliente las 24 horas para garantizar que tu experiencia de software sea perfecta desde la compra hasta la instalación.",
    "about.partner.title": "Partner Certificado de Microsoft",
    "about.partner.description": "Oficialmente autorizado para vender productos genuinos de Microsoft",
    "about.benefits.1": "Licencias 100% genuinas de Microsoft con garantía completa",
    "about.benefits.2": "Entrega digital instantánea en segundos",
    "about.benefits.3": "Soporte al cliente experto 24/7",
    "about.benefits.4": "Garantía de mejor precio con pagos seguros",
    "about.values.title": "Nuestros Valores Fundamentales",
    "about.values.description": "Los principios que guían todo lo que hacemos",
    "about.values.trust.title": "Confianza y Autenticidad",
    "about.values.trust.description": "Solo vendemos productos 100% genuinos de Microsoft obtenidos directamente de canales autorizados.",
    "about.values.quality.title": "Servicio de Calidad",
    "about.values.quality.description": "Excelencia en cada interacción, desde la navegación hasta el soporte post-compra.",
    "about.values.customer.title": "Cliente Primero",
    "about.values.customer.description": "Tu satisfacción es nuestra prioridad. Vamos más allá por cada cliente.",
    "about.values.speed.title": "Velocidad y Eficiencia",
    "about.values.speed.description": "Entrega instantánea y tiempos de respuesta rápidos porque tu tiempo importa.",
